<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:36:"./template/default/pc/index_top.html";i:1563714578;s:69:"I:\work\project\php\website_nav\template\default\pc\index_header.html";i:1563714225;s:69:"I:\work\project\php\website_nav\template\default\pc\index_footer.html";i:1563714714;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<title>
			网站排行榜 - <?php echo config('web.WEB_TIT'); ?>
		</title>
		<meta name="keywords" content="<?php echo config('web.WEB_KEY'); ?>">
		<meta name="description" content="<?php echo config('web.WEB_DES'); ?>">
		
		<link rel="stylesheet" href="/template/default/public/pc/css/top.css?20190621">
...
<div class="bg">
			<img src="/template/default/public/pc/img/toptext.png">
			<div class="type">				
              <ul>
                                 
                <li> <a <?php if($type == 'today'): ?>class="hover"<?php endif; ?> href="/top.html?type=today">今日榜单</a> </li>
                                
                <li> <a <?php if($type == 'art'): ?>class="hover"<?php endif; ?> href="/top.html?type=art">总榜巅峰</a> </li>
			...
			<div>
				<ul class="lists">
                  ...
                  <li class="layui-clear">		
                    ...
                    <a href="<?php if(config('web.WEB_URL') == 1): ?>/daohang/<?php echo $vo['id']; ?>.html<?php else: ?>/index.php/daohang/<?php echo $vo['id']; ?>.html<?php endif; ?>" class="weblogo" target="_blank">
							
                      <img src="<?php if($vo['pic'] != ''): ?><?php echo $vo['pic']; else: ?>/public/img/cover.png<?php endif; ?>"height="80">
						
                    </a>
						
                    <p class="introduce">
							
                      [<?php echo $vo['title']; ?>]	 - <?php echo $vo['lianjie']; ?>
                    </p>
                     <p class="introduce">
                       <?php echo $vo['description']; ?>
                    </p>
						 
                    <span class="click"><?php if($type == 'art'): ?><?php echo $vo['view']; endif; if($type == 'today'): ?><?php echo $vo['count']; endif; ?>人点击</span>
						
                    <a href="http://<?php echo $vo['lianjie']; ?>/<?php echo config('web.WEB_HZ'); ?>" class="go topdj" data-id="<?php echo $vo['id']; ?>" target="_blank">去看看</a>
