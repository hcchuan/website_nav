<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"I:\work\project\php\website_nav\thinkphp\tpl\dispatch_jump.tpl";i:1561975858;}*/ ?>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=0.5, maximum-scale=2.0, user-scalable=yes" />  
    ...
    <style type="text/css">
        ...
        .ip-attack{width:100%; margin:100px auto 0;}
...
<body>
    <div class="ip-attack"><dl>
     <div style="margin-bottom:50px;" align="center"> <img src="/public/img/logo.png" height="80" alt=""> </div>
